  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex gap-4 border-b border-slate-100">
        <Link
          to="/mis-auditorias"
          className="border-b-2 border-transparent pb-3 text-sm font-bold text-slate-500 transition-all hover:text-slate-800"
        >
          Por realizar
        </Link>
        ...
        <Link
          ...
          className="border-b-2 border-emerald-600 pb-3 text-sm font-bold text-emerald-800 transition-all"
        >
          Historial
        </Link>
      </div>
