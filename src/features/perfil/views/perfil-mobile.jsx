  ...
  return (
    <div className="space-y-4 pb-8">
      ...
      <div>
        ...
        <h1 className="text-2xl font-black text-slate-950">Mi Perfil</h1>
      ...
      {/* Segmented Control */}
      <div className="bg-white/80 backdrop-blur-xl p-1 rounded-2xl shadow-sm border border-slate-200/80">
        <div className="flex bg-slate-100/90 p-1 rounded-xl border border-slate-200/60">
          <button
            ...
            className={`flex-1 flex justify-center items-center gap-2 py-2 text-xs font-bold rounded-lg transition-all duration-200 ${
              activeTab === 'general'
                ? 'bg-marca-primario text-white shadow-md shadow-marca-primario/20'
              ...
              {!editing && (
                <div className="flex justify-end mb-3">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-amber-700 bg-amber-50 border border-amber-200/80 rounded-xl shadow-sm hover:bg-amber-100 transition-colors"
                  >
